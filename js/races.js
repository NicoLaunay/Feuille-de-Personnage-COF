export const RACES = new Map([
  ["halfElf", new Map([
    ...
    ["weightMin", 40.00], ["weightMax", 80.00],
    ["skillName", "Sang mêlé"],
    ["skillDescription", `Le demi-elfe choisit l'une des deux capacités suivantes: <br>
                            Instinct de survie (humain): <br>
                            lorsqu'une attaque devrait amener le PJ à 0 PV, les DM qu'elle inflige sont divisés par 2 (minimum 1)<br>
                            Lumière des étoiles (elfe): <br>
  ...
  ["highElf", new Map([
    ...
    ["weightMin", 40], ["weightMax", 70],
    ["skillName", "Lumière des étoiles"],
  ...
  ["woodElf", new Map([
    ...
    ["weightMin", 30.00], ["weightMax", 70.00],
    ["skillName", "Lumière des étoiles"],
  ...
  ["gnome", new Map([
    ...
    ["weightMin", 30.00], ["weightMax", 50.00],
    ["skillName", "Don étrange"],
    ["skillDescription", `le gnome possède un talent inné pour les sciences, qu’elles soient occultes ou plus ordinaires.<br>
                            Le joueur choisit une des deux options suivantes : <br>
                            Soit son personnage gagne un bonus de +5 sur tous les tests d’INT ;<br>
  ...
  ["halfling", new Map([
    ...
    ["weightMin", 20], ["weightMax", 30],
    ["skillName", "Petite taille"],
    ["skillDescription", ` le Halfelin obtient un bonus de +1 en DEF et de +2 à tous les tests de discrétion. En revanche, 
                            un Halfelin peut seulement utiliser à une main une arme dont les DM sont au maximum égaux à 1d6 
  ...
  ["human", new Map([
    ...
    ["weightMin", 40.00], ["weightMax", 120.00],
    ["skillName", "Instinct de survie"],
  ...
  ["dwarf", new Map([
    ...
    ["weightMin", 50.00], ["weightMax", 100.00],
    ["skillName", "Vision dans le noir"],
    ["skillDescription", `Dans le noir total, le Nain voit comme dans la pénombre jusqu’à 30 m.`]])]
]);